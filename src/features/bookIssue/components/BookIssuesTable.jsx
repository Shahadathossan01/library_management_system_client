      ...
      <Table sx={{ minWidth: 650 }} size="small" aria-label="a dense table">
        <TableHead>
          <TableRow sx={{ bgcolor: "gray" }}>
            ...
            <TableCell sx={{ color: "white", width: "30%" }} align="center">
              Book Name
            </TableCell>
            <TableCell sx={{ color: "white", width: "30%" }} align="center">
              Author Name
            </TableCell>
            <TableCell sx={{ color: "white", width: "10%" }} align="center">
              Status
            </TableCell>
            <TableCell sx={{ color: "white", width: "10%" }} align="center">
              Issue Date
            </TableCell>
            <TableCell sx={{ color: "white", width: "20%" }} align="center">
              Action
            </TableCell>
          </TableRow>
        </TableHead>
            ...
            bookIssues?.map((item, index) => (
              ...
              >
                ...
                <TableCell align="center">
                  {item?.status == "public_hand" ? "own_hand" : item?.status}
                </TableCell>
                <TableCell align="center">
                ...
                <TableCell align="center">
                  ...
                  >
                    ...
                    user?.role !== "admin" ? (
                      ...
                      <IconButton
                        onClick={() => handleDeleteBookIssue({ id: item?._id })}
                      >
